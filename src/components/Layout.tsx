...
import { IconAlertCircle, IconArrowBackUp, IconCalendar, IconFileText, IconLayoutDashboard, IconMenu2 } from '@tabler/icons-react';
...
const APP_TITLE = 'HelfRecht Management Suite';
...
const navigation = [
  ...
  { name: 'Fachbücher', href: '/fachbuecher', icon: IconFileText },
  { name: 'Fachmagazin', href: '/fachmagazin', icon: IconFileText },
  { name: 'Kongresszentrum', href: '/kongresszentrum', icon: IconFileText },
  { name: 'LeadAir Web-Software', href: '/leadair-web-software', icon: IconFileText },
  { name: 'Veranstaltungen', href: '/veranstaltungen', icon: IconCalendar },
  { name: 'Unternehmensdaten', href: '/unternehmensdaten', icon: IconFileText },
  { name: 'Berater', href: '/berater', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Fachbücher', href: '/gateway/apps/6859413e4aad621c4ce19829?template=list_page', icon: IconFileText },
  { name: 'Fachmagazin', href: '/gateway/apps/6859413e462ab91026a3e9cf?template=list_page', icon: IconFileText },
  { name: 'Kongresszentrum', href: '/gateway/apps/6859413c6f638c0c97985da3?template=list_page', icon: IconFileText },
  { name: 'LeadAir Web-Software', href: '/gateway/apps/6859413fb1744fb0c3c5282c?template=list_page', icon: IconFileText },
  { name: 'Veranstaltungen', href: '/gateway/apps/6859413d4523fb4c4bde789b?template=list_page', icon: IconCalendar },
  { name: 'Unternehmensdaten', href: '/gateway/apps/6859412eb907652ead444121?template=list_page', icon: IconFileText },
  { name: 'Berater', href: '/gateway/apps/6859413c72f4a3bcd174a800?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/6859413e4aad621c4ce19829?template=list_page"
