      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.berater_telefon ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Fachgebiet</Label>
            <p className="text-sm">{record.fields.berater_fachgebiet ?? '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.berater_email ?? '—'}</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
